                        ...
                        <div className="col-lg-12">
                            <div className="hero-style7">
                                ...
                                <div className="hero-flex-wrap">
                                    ...
                                    <p className="hero-text wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">Beautiful design has the power to captivate audiences. VEXA specializes in creating stunning designs.</p>
