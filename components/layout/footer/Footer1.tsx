                ...
                <div className="footer__area dark-bg">
                    <div className="container">
                        <div className="footer__cta-wrap pt-115 pb-120">
                            ...
                            <h2 className="footer__cta-wrap-title"><Link className="link-btn text-white" href="/contact">Démarrons votre project <i className="icon-arrow-top-left" /></Link></h2>
                        </div>
                        <div className="footer__top fix">
                            <div className="row justify-content-between">
                                <div className="col-xl-auto col-md-6">
                                    <div className="footer__widget footer__location">
                                        <h4 className="footer__widget-title">Localisation</h4>
                                ...
                                <div className="col-xl-auto col-md-6">
                                    <div className="footer__widget footer__conversation">
                                        <h4 className="footer__widget-title">Démarrer une conversation</h4>
                                        <div className="footer__content">
                                            <p><Link href="mailto:contact@tekbot.io">contact@tekbot.io</Link>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-auto col-md-6">
                                    <div className="footer__widget footer__copyright">
                                        <h4 className="footer__widget-title">© {new Date().getFullYear()} Tekbot Robotics, Tous droits réservés.</h4>
                    ...
                    <div className="footer__bottom">
                        <div className="container text-center">
                            <button className="scroll__footer-top scroll-to-target open text-white" data-target="html">
                                Aller en haut <i className="fas fa-arrow-up" />
                            </button>
                        </div>
                    </div>
                </div>
